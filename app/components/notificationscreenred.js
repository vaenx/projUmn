...
export default class NotificationScreenRed extends React.Component {
  render() {
    return (
      <ImageBackground source={{uri: 'bg_red_motive'}} style={styles.bgImage}>
        <View style={styles.container}>
          <Text style={styles.textTitle}>Your Time is Limited</Text>
          <View style={styles.smallerContainer}>
            <Text style={styles.textBody}>Total overtime this month</Text>
            <Text style={styles.textTimeLimit}>[overtime]</Text>
          </View>
          <Text style={styles.textInfo}>
            You have lived 35% of your life and each minute counts to achieve your goals.
          </Text>
